 ...
 * InfoIsPublic
 *
 * @ORM\Table(name="becowo_info_is_public", uniqueConstraints={@ORM\UniqueConstraint(name="id_UNIQUE", columns={"id"})}, indexes={@ORM\Index(name="fk_member_id_idx", columns={"member_id"})})
 * @ORM\Entity
 */
class InfoIsPublic
{
