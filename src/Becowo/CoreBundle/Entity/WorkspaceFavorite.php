 ...
 * WorkspaceFavorite
 *
 * @ORM\Table(name="becowo_workspace_favorite", uniqueConstraints={@ORM\UniqueConstraint(name="id_UNIQUE", columns={"id"})}, indexes={@ORM\Index(name="fk_workspace_id_idx", columns={"workspace_id"})})
 * @ORM\Entity
 */
